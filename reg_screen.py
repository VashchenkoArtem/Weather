...
def save_to_database(entry1, entry2, entry3, entry4):
    ...
    # После сохранения данных вызываем функцию отображения
    display_entries()
...
def display_entries():
    ...
    back.pack() 
    # Отображение первого значения из глобальной переменной
    ...
    label_1.place(x=119, y=157)  # Измените координаты в соответствии с вашими требованиями

    # Отображение второго значения из глобальной переменной
    ...
    label_2.place(x=121, y=256)  # Измените координаты в соответствии с вашими требованиями

    # Отображение третьего значения из глобальной переменной
    ...
    label_3.place(x=119, y=352)  # Измените координаты в соответствии с вашими требованиями

    # Отображение четвертого значения из глобальной переменной
    ...
    label_4.place(x=119, y=455)  # Измените координаты в соответствии с вашими требованиями
    ...
    # Кнопка для открытия окна ввода данных
    open_input_window_button = customtkinter.CTkButton(data_display_window, text="Перейти до додатку", command=m_big.big_screen, bg_color = "#5DA7B1", fg_color= "#096C82", text_color= "white", width = 218, height = 46, border_width= 5, border_color="white", corner_radius= 20)
    ...
    return data_display_window
     # Измените координаты в соответствии с вашими требованиями
