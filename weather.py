...
def update_weather(city,temp_lable,weather_label,sunrise_lable, sunset_ladel,condition_label,window):
...
def future_weather(city):
    ...
    # except:
        # print('Error')
def update_future_weather(city):
    temp_current, current_description, hour_time, hour_temp, hour_descriprion, hour_2_temp = future_weather(city)
    data = future_weather(city)
        # temp_lable.configure(text= f'{temp_current}')
    print("current temp - ", temp_current)
    print("hour_temp - ", data[4])
    print("current_description - ", current_description)
    print("hour_time - ", data[3])
    print("hour_descriprion - ",data[2] )
    print(hour_2_temp)
